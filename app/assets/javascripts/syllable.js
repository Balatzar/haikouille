...
})(
  {
    1: [
      function(require, module, exports) {
        ...
        window.syllable = require("syllable");
      ...
      function(require, module, exports) {
        (function(global, factory) {
          ...
          function normalize(str, custom_charmap) {
            ...
            regex =
              regex && old_charmap === current_charmap
                ? regex
                : buildRegExp(current_charmap);

            return str.replace(regex, function(charToReplace) {
              return (
                current_charmap[charToReplace.charCodeAt(0)] || charToReplace
              );
            });
          }
 ...
 * a given value. */
        ...
        function syllables(value) {
          ...
          while (++index < length) {
            total += syllable(
              values[index].replace(EXPRESSION_NONALPHABETIC, "")
            );
          }
  ...
  * value from the input. */
      ...
      { "./problematic.json": 6, "normalize-strings": 3, pluralize: 4 }
    ],
    6: [
      function(require, module, exports) {
        module.exports = {
